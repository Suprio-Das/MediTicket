        ...
        <div className="mx-auto doctors p-5">
            ...
            <section>
                ...
                <div className='my-18 grid grid-cols-3 gap-5'>
                    <div className='shadow-md p-2 bg-white relative h-48 border-2 border-[#275596] rounded-xl'>
                        <div className='absolute -top-14 left-[35%]'>
                            <img src={Medicine[0].profile_picture} alt="" className='w-28 h-28 rounded-full border-4 border-[#275596]' />
                        </div>
                        <div className='text-center mt-18'>
                            <p><span className='font-semibold'>Name:</span> {Medicine[0].name}</p>
                            <p><span className='font-semibold'>Degree:</span> {Medicine[0].degree}</p>
                            <p><span className='font-semibold'>Chamber:</span> {Medicine[0].chamber}</p>
                        </div>
                    </div>
                </div>
            </section>
